...
namespace PlayFab.Samples
{
    ...
    {
        public CloudScriptModels.PlayerProfileModel PlayerProfile { get; set; }
        public bool PlayerProfileTruncated { get; set; }
        public CloudScriptModels.PlayStreamEventEnvelopeModel PlayStreamEventEnvelope { get; set; }
        public TitleAuthenticationContext TitleAuthenticationContext { get; set; }
        public bool? GeneratePlayStreamEvent { get; set; }
        public T FunctionArgument { get; set; }
    }
    ...
    {
        public CloudScriptModels.NameIdentifier ScheduledTaskNameId { get; set; }
    ...
    public class EntityPlayStreamEvent<T>
    {
        ...
        public ProfilesModels.EntityLineage EntityLineage { get; set; }
    }
